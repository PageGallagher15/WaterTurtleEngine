...
void Mesh::Render(Camera* camera_, std::vector<glm::mat4> instances_) {
	...
	glUniform3f(lightPosLoc, camera_->GetLightSource()[0]->GetPosition().x, camera_->GetLightSource()[0]->GetPosition().y, camera_->GetLightSource()[0]->GetPosition().z);
	glUniform1f(lightAmbientLoc, camera_->GetLightSource()[0]->GetAmbient());
	glUniform1f(lightDiffuseLoc, camera_->GetLightSource()[0]->GetDiffuse());
	glUniform3f(lightColourLoc, camera_->GetLightSource()[0]->GetLightColour().x, camera_->GetLightSource()[0]->GetLightColour().y, camera_->GetLightSource()[0]->GetLightColour().z);
